...
namespace project_airlines.Controllers
{
	public class SupplierController : Controller
	{
		...
		//this is an action method that handles HTTP GET requests to the "Index" endpoint.
		//It retrieves a list of suppliers from the database using "_db.Suppliers.ToList() and passes it to a view. This view is typically used to display a list of suppliers
		...
		//[ValidateAntiForgeryToken] This attribute helps protect against cross-site request forgery (CSRF) attacks.
